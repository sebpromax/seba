...
(function () {
  ...
  function togglePanel() {
    ...
    panel.style.cssText = 'position:fixed;inset:auto 12px 12px 12px;max-height:50vh;overflow-y:auto;background:#0a0a0c;color:#e5e7eb;font:12px/1.5 monospace;border:1px solid rgba(0,255,136,.35);border-radius:10px;padding:12px 14px;z-index:9999;box-shadow:0 16px 48px rgba(0,0,0,.5);';
    panel.innerHTML = '<div style="display:flex;justify-content:space-between;margin-bottom:8px;">' +
      '<b style="color:#00ff88;">Log système Seba (' + LOGS.length + ')</b>' +
